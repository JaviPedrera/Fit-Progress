...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable {
	...
	/**
	 * When grouping all events into a collection we need to filter them by type.
	 * This function will return the type without displaying the full route.
	 * 
	 * @return string
	 */
	public function eventType()
	{
		$eventType = str_replace('App\\Models\\', '', get_class($this));
	...
	/**
	 * This function will return the event translated for displaying it as a string.
	 * 
	 * @return string
	 */
	...
	/**
	 * This function will return the appropriate string for printing the icon.
	 * 
	 * @return string
	 */
